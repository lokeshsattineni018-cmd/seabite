  ...
  const handleSpin = async () => {
    ...
    try {
      ...
      if (backendResult.result === "BETTER_LUCK") {
        // Find a "Better Luck!" segment
        prizeIndex = prizes.findIndex((p) => p.value === 0);
      } else {
        // Find matching discount value
