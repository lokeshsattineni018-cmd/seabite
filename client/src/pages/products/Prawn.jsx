    ...
    axios
      ...
      .then((res) => {
        ...
        const prawns = res.data.products.filter((p) => 
          p.category === "Prawn" || p.category === "Prawns"
        );
        setItems(prawns);
        setLoading(false);
      })
      ...
      <div className="relative pt-28 pb-12 px-6 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            ...
            >
              Juicy Tiger prawns, King prawns, and freshwater scampi. 
      ...
      <div className="max-w-7xl mx-auto px-6 pb-24">
                ...
                <div className="bg-white p-4 rounded-[2.5rem] shadow-sm border border-transparent hover:border-orange-200 hover:shadow-xl hover:shadow-orange-900/5 transition-all duration-500 relative overflow-hidden">
                  ...
                  <div className="pt-6 pb-2 px-2 text-center">
                    ...
                    <div className="flex items-center justify-center gap-2 mb-3">
                      ...
                      <span className="text-xs text-slate-400 line-through">₹{Math.round(item.price * 1.1)}</span>
                    </div>
        ...
        {!loading && items.length === 0 && (
          <div className="text-center py-20 bg-white/50 rounded-3xl border border-dashed border-slate-300">
            <p className="text-slate-400 text-lg">No prawns available today.</p>
          </div>
        )}
      </div>
