    ...
    <div style={{
      ...
      >
              ...
              {order.items.map((item, idx) => (
                <div 
                  ...
                  style={{
                    ...
                    background: "#FFFFFF", border: `1.5px solid ${T.border}`,
                    borderRadius: "16px", padding: "10px 14px", flexShrink: 0, minWidth: "210px"
                  }}
                >
                  <img 
                    src={item.image} 
        ...
        <motion.div
          ...
          style={{ display: "flex", alignItems: "center", justifyContent: "space-between", borderTop: `1.5px solid ${T.border}`, paddingTop: 18 }}
        >
