          ...
          <div style={{ display: "grid", gridTemplateColumns: "210px 1fr", gap: 20, alignItems: "start" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 14, position: "sticky", top: 88 }}>
              ...
              <div style={{ background: T.surface, borderRadius: T.radius, border: `1px solid ${T.border}`, padding: "16px 14px", boxShadow: "0 2px 12px rgba(91,168,160,0.06)" }}>
                <p style={{ fontSize: 9, fontWeight: 800, color: T.primary, textTransform: "uppercase", letterSpacing: "0.14em", marginBottom: 12, margin: "0 0 12px" }}>Overview</p>
                {[
                  { label: "Total Orders", value: tabCounts.All },
                  { label: "Delivered", value: tabCounts.Delivered },
                  { label: "Active", value: tabCounts.Active },
                  { label: "Total Spent", value: formatCurrency(totalSpent) },
                  { label: "Total Saved", value: formatCurrency(totalSaved), highlight: true },
                ].map(row => (
                  <div key={row.label} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", paddingBottom: 8, marginBottom: 8, borderBottom: "1px solid #F0F5F4" }}>
                    <span style={{ fontSize: 11, color: T.textLite, fontWeight: 500 }}>{row.label}</span>
                    <span style={{ fontSize: 11, fontWeight: 800, color: row.highlight ? T.primary : T.textDark }}>{row.value}</span>
                  </div>
                ))}
              </div>
              ...
              {/* Filter card */}
              <div style={{ background: T.surface, borderRadius: T.radius, border: `1px solid ${T.border}`, padding: "16px 14px", boxShadow: "0 2px 12px rgba(91,168,160,0.06)" }}>
                <p style={{ fontSize: 9, fontWeight: 800, color: T.primary, textTransform: "uppercase", letterSpacing: "0.14em", margin: "0 0 10px" }}>Filter</p>
                    ...
                    return (
                      <button key={tab} onClick={() => setActiveTab(tab)}
                        style={{
                          ...
                          boxShadow: isActive ? "0 3px 10px rgba(91,168,160,0.22)" : "none",
              ...
              {/* Sort card */}
              <div style={{ background: T.surface, borderRadius: T.radius, border: `1px solid ${T.border}`, padding: "16px 14px", boxShadow: "0 2px 12px rgba(91,168,160,0.06)" }}>
                <p style={{ fontSize: 9, fontWeight: 800, color: T.primary, textTransform: "uppercase", letterSpacing: "0.14em", margin: "0 0 10px" }}>Sort</p>
                    ...
                    return (
                      <button key={s.v} onClick={() => setSortBy(s.v)}
                        style={{
                          ...
                          background: isSel ? "rgba(91,168,160,0.08)" : "transparent",
                          color: isSel ? T.primary : T.textMid,
