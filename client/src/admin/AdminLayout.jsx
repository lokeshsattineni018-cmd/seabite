  ...
  return (
    <div className="flex h-screen bg-slate-50 font-sans overflow-hidden relative">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
         ...
         <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-slate-200/50 rounded-full blur-[100px] -translate-x-1/3 translate-y-1/3" />
      </div>
      ...
      <aside className="hidden md:block w-64 lg:w-72 bg-white border-r border-slate-200 z-20 flex-shrink-0 relative h-full">
        <AdminSidebar />
      </aside>

      {/* MAIN CONTENT AREA */}
      <main className="flex-1 relative z-10 overflow-y-auto scroll-smooth">
        {/* Added top padding for mobile header offset */}
