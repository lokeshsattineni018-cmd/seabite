    ...
    <div className="p-6 md:p-10 bg-slate-50 min-h-screen">
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100 mb-8">
        ...
        >
          ...
          <button
            type="submit"
            className="bg-blue-600 text-white font-bold rounded-lg py-2 hover:bg-blue-700"
          >
            Create
          </button>
        </form>
      ...
      <div className="grid gap-4">
        {coupons.map((coupon) => (
          <div
            key={coupon._id}
            className="bg-white p-4 rounded-xl shadow-sm flex justify-between items-center border-l-4 border-blue-500"
          >
            <div>
